                ...
                <div className="w-full md:w-[83%] bg-[#F5F7FA]  rounded p-4 mt-0 relative">
                    ...
                    <div className=" w-full flex flex-col md:flex-row md:justify-between mb-4 mt-12">
                        <div className=" w-full md:w-[69.5%]">
                            <div className="flex flex-col md:flex-row justify-between mb-5">
                                <div className="w-full md:w-[49.5%] shadow-dashboardShadow rounded-xl bg-white p-4 mb-5 md:mb-0 ">
                                    ...
                                    <p className="text-textGrey text-sm font-medium mb-3">Total Revenue</p>
                                    <p className="text-firstBlack text-[40px] font-bold mb-3">
                                        <CountUp start={0} end={154140} duration={2} separator="," decimals={2} prefix="$" />
                                    </p>
                                    <div className="flex gap-4 items-center mb-3">
                                        <Image
                                            ...
                                            className=""
                                        />
                                        <p className="text-textGrey text-sm font-medium">Activity from July 1st to July 31th</p>

                                    </div>
                                    <div className=" border border-b-[#99B2C64A]"></div>
                                    <div className="flex gap-2 items-center py-5 px-2">
                                        <p className="text-base text-firstBlack font-semibold">View Report</p>
                                        <GoArrowRight />
                                    </div>
                                ...
                                <div className="w-full md:w-[49.5%] shadow-dashboardShadow rounded-xl bg-white p-4 ">
                                    ...
                                    <p className="text-textGrey text-sm font-medium mb-3">Total Audience</p>
                                    <p className="text-firstBlack text-[40px] font-bold mb-3">
                                        <CountUp start={0} end={148.043} duration={2} separator="," decimals={2} prefix="" />
                                    </p>
                                    <div className="flex gap-4 items-center mb-3">
                                        <Image
                                            src="/images/activity.svg"
                            ...
                            <div className="shadow-dashboardShadow rounded-xl bg-white p-5 mb-5 md:mb-0">
                                <div className="flex flex-col md:flex-row justify-between">
                                    <p className="text-2xl font-bold text-firstBlack mb-2 md:mb-0">Advanced Insights</p>
                                    <div className="flex gap-5">
                                        <div className="flex p-2 px-3 items-center gap-2 border-[1.5px] border-[#F1F5F7] rounded-lg">
                                            ...
                                            <p className=" text-textGrey text-sm font-medium">Total Views</p>
                                        </div>
                                        <div className="flex p-2 px-3 items-center gap-2 border-[1.5px] border-[#F1F5F7] rounded-lg">
                                            <MdOutlineCircle className="w-3 text-[#C686F8]" />
                                            <p className=" text-textGrey text-sm font-medium">Product Sales</p>
                                        </div>
                                    </div>
                                </div>
                                <LineChartComponent />
                        ...
                        <div className=" w-full md:w-[29.5%] bg-white rounded-xl shadow-dashboardShadow p-4">
                                    ...
                                    <tbody>
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Domain Purchase</span>
                                                <span className="block text-textGrey text-sm font-medium">Nigeria</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                                                    <p className=" text-textGrey text-sm font-medium">paid</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Premium Package</span>
                                                <span className="block text-textGrey text-sm font-medium">Kenya</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                                        ...
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Domain Purchase</span>
                                                <span className="block text-textGrey text-sm font-medium">South Africa</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                                        ...
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Investment Guide</span>
                                                <span className="block text-textGrey text-sm font-medium">Ghana</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                                        ...
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Go To Market</span>
                                                <span className="block text-textGrey text-sm font-medium">Egypt</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                                        ...
                                        <tr className="bg-white border-b border-[#F1F5F7]">
                                            <td scope="row" className=" py-3 ">
                                                <span className="block text-base font-semibold text-firstBlack">Website Design</span>
                                                <span className="block text-textGrey text-sm font-medium">Tanzania</span>
                                            </td>
                                            <td className="">
                                                <div className=" flex gap-1 items-center">
                                                    <IoCheckmarkCircleSharp className="text-primary-500" />
                            ...
                            <p className="text-center py-6 text-xl font-bold text-firstBlack">Conversation Rate</p>
                            <PieChartComponent />
                            {/* <Image
                            ...
                            <div className=" flex gap-3 justify-center items-center mb-6">
                                <p className="text-[13px] font-semibold text-primary-500">+3,5%</p>
                                <p className="text-firstBlack text-sm font-medium">latest activity</p>
                            </div>
                            <div className="flex justify-between">
                                <div className="flex justify-center  p-2  items-center gap-1 border-[1.5px] border-firstBlack rounded-lg w-[32%]">
                                    ...
                                    <p className=" text-firstBlack text-sm font-medium">Audience</p>
                                </div>
                                <div className="flex justify-center  p-2  items-center gap-1 border-[1.5px] border-firstBlack rounded-lg w-[32%]">
                                    <MdOutlineCircle className="w-3 text-[#86F3A6] " />
                                    <p className=" text-firstBlack text-sm font-medium">Visitors</p>
                                </div>
                                <div className="flex justify-center  p-2  items-center gap-1 border-[1.5px] border-firstBlack rounded-lg w-[32%]">
